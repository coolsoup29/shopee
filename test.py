...
def get_goods(data, STOPTIME):
    ...
    s.keep_alive = False
    print("test1111")
    c_time = time.ctime().split(" ")[3].split(":")[1]
    ...
    try:
        ...
        if ran % 2 == 1:
            ...
            driver.get(data[2])
            wait.until(EC.presence_of_element_located((By.XPATH, "//div[@class='_3n5NQx']")))
...
if __name__ == "__main__":
    ...
    #     mul_main()
    get_goods([0,0,'https://shopee.co.id/Big-Promo-JAM-TANGAN-PRIA-COWOK-EMPORIO-ARMANI-ORIGINAL-BM-CASIO-BONIA-HEGNER-BALMER-MIRAGE-TETONIS-i.64522090.1240178220',0,0,0],5)